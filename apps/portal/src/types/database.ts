...
export interface Database {
  public: {
    Tables: {
      ...
      // Mobile Docs Facility Directory tables
      ...
      facility_contacts: {
        Row: FacilityContact;
        Insert: Omit<FacilityContact, 'id' | 'created_at' | 'updated_at'>;
        Update: Partial<Omit<FacilityContact, 'id' | 'created_at'>>;
      };
      facility_notes: {
        Row: FacilityNote;
        Insert: Omit<FacilityNote, 'id' | 'created_at'>;
        Update: never; // Append-only
      };
      facility_census: {
        Row: FacilityCensus;
        Insert: Omit<FacilityCensus, 'id'>;
        Update: Partial<Omit<FacilityCensus, 'id'>>;
      };
      facility_pipeline: {
        Row: FacilityPipelineEntry;
        Insert: Omit<FacilityPipelineEntry, 'id' | 'changed_at'>;
        Update: never; // Append-only audit trail
      };
      // AWV Tracker Module tables (awv_ prefix)
      awv_patients: {
        Row: AwvPatient;
        Insert: Omit<AwvPatient, 'id' | 'created_at' | 'updated_at'>;
        Update: Partial<Omit<AwvPatient, 'id' | 'created_at'>>;
      };
      awv_tracking: {
        Row: AwvTracking;
        Insert: Omit<AwvTracking, 'id' | 'created_at' | 'updated_at'>;
        Update: Partial<Omit<AwvTracking, 'id' | 'created_at'>>;
      };
      awv_uploads: {
        Row: AwvUpload;
        Insert: Omit<AwvUpload, 'id' | 'created_at'>;
        Update: Partial<Pick<AwvUpload, 'status' | 'row_count' | 'new_patients' | 'updated_patients' | 'flagged_patients' | 'validation_errors'>>;
      };
      awv_reimbursement_rates: {
        Row: AwvReimbursementRate;
        Insert: Omit<AwvReimbursementRate, 'id'>;
        Update: Partial<Omit<AwvReimbursementRate, 'id'>>;
      };
      awv_addons: {
        Row: AwvAddon;
        Insert: Omit<AwvAddon, 'id' | 'created_at'>;
        Update: Partial<Omit<AwvAddon, 'id' | 'created_at'>>;
      };
      // CCM / RPM Tracker Module tables (ccm_ prefix)
      ccm_patients: {
        Row: CcmPatient;
        Insert: Omit<CcmPatient, 'id' | 'created_at' | 'updated_at'>;
        Update: Partial<Omit<CcmPatient, 'id' | 'created_at'>>;
      };
      ccm_enrollment: {
        Row: CcmEnrollment;
        Insert: Omit<CcmEnrollment, 'id' | 'created_at' | 'updated_at'>;
        Update: Partial<Omit<CcmEnrollment, 'id' | 'created_at'>>;
      };
      ccm_devices: {
        Row: CcmDevice;
        Insert: Omit<CcmDevice, 'id' | 'created_at' | 'updated_at'>;
        Update: Partial<Omit<CcmDevice, 'id' | 'created_at'>>;
      };
      ccm_reimbursements: {
        Row: CcmReimbursement;
        Insert: Omit<CcmReimbursement, 'id' | 'created_at'>;
        Update: never; // Append-only
      };
      ccm_uploads: {
        Row: CcmUploadRow;
        Insert: Omit<CcmUploadRow, 'id' | 'created_at'>;
        Update: Partial<Pick<CcmUploadRow, 'status' | 'row_count' | 'new_patients' | 'updated_patients' | 'flagged_patients' | 'validation_errors'>>;
      };
      ccm_reimbursement_rates: {
        Row: CcmReimbursementRate;

...
import { useAwvUploadHistory } from '@/hooks/useAwvUpload';
import type { AwvUploadStatus } from '@/types/awv-tracker';

const STATUS_CONFIG: Record<AwvUploadStatus, { bg: string; text: string }> = {
...
export function UploadHistoryTable() {
  const { data: uploads, isLoading } = useAwvUploadHistory();
